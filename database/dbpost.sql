...
-- 1. OEM MANUFACTURERS
-- ============================================================================
CREATE TABLE aoem.oem_manufacturers (
...
-- 2. SERVICE CENTERS
-- ============================================================================
CREATE TABLE aoem.service_centers (
    id SERIAL PRIMARY KEY,
...
-- ============================================================================
CREATE TABLE aoem.oem_service_centers (
    id SERIAL PRIMARY KEY,
...
-- 6. PARTS CATALOG
-- ============================================================================
CREATE TABLE aoem.parts_catalog (
    id SERIAL PRIMARY KEY,
    oem_id INTEGER NOT NULL REFERENCES aoem.oem_manufacturers(id),
...
-- 7. VEHICLES
-- ============================================================================
CREATE TABLE aoem.vehicles (
    id SERIAL PRIMARY KEY,
    vin VARCHAR(20) NOT NULL UNIQUE,
    oem_id INTEGER NOT NULL REFERENCES aoem.oem_manufacturers(id),
    model VARCHAR(100) NOT NULL,
    model_year INTEGER NOT NULL,
    customer_id INTEGER NULL REFERENCES aoem.users(id),
...
-- 9. WARRANTY CLAIMS
-- ============================================================================
CREATE TABLE aoem.warranty_claims (
    id SERIAL PRIMARY KEY,
...
-- =========================================================================
CREATE TABLE aoem.warranty_claim_status_logs (
    id SERIAL PRIMARY KEY,
...
-- =========================================================================
CREATE TABLE aoem.service_records (
    id SERIAL PRIMARY KEY,
    vehicle_id INTEGER NOT NULL REFERENCES aoem.vehicles(id),
    service_center_id INTEGER NOT NULL REFERENCES aoem.service_centers(id),
...
('BYDHAN111222333444', 2, 'Han EV', 2024, NULL, '{"variant":"Standard","odometer_km":12000,"color":"Black","purchase_date":"2024-02-20"}', '{"start_date":"2024-02-20","end_date":"2030-02-20","km_limit":120000,"policies":[{"component":"battery","months":72,"km":120000}],"certificates":[{"number":"WC-BYD-001","status":"active"}]}');
